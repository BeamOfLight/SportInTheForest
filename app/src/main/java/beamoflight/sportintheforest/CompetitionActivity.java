...
//                        createCompetitionResponseHandler.sendMessage(msg);
    ...
    private void initDialogCompetitionMove()
    {
        ...
        final Spinner spinner_pre_action = (Spinner) prompts_view.findViewById(R.id.spinnerPreAction);
        ...
        final Spinner spinner_target = (Spinner) prompts_view.findViewById(R.id.spinnerTarget);

        final Spinner spinner_action = (Spinner) prompts_view.findViewById(R.id.spinnerAction);
