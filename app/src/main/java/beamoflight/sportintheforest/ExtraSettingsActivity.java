...
public class ExtraSettingsActivity extends Activity {
    ...
    {
        new AlertDialog.Builder(ExtraSettingsActivity.this)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.extra_settings);
        ...
        btnAddExercise.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                turnOnOffButtons(false);
                Intent intent = new Intent(ExtraSettingsActivity.this, ExercisesActivity.class);
        ...
        btnTest.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                turnOnOffButtons(false);
                //Intent intent = new Intent(ExtraSettingsActivity.this, CompetitionViewerActivity.class);
                Intent intent = new Intent(getBaseContext(), ReplayEditorActivity.class);
                startActivity(intent);
                turnOnOffButtons(true);
            }
        });
