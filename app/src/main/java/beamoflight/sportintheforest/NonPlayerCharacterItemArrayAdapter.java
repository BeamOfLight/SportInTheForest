...
public class NonPlayerCharacterItemArrayAdapter extends ArrayAdapter<NonPlayerCharacterEntity> {
    private final Context context;
    private final List<NonPlayerCharacterEntity> values;

    public NonPlayerCharacterItemArrayAdapter(Context context, List<NonPlayerCharacterEntity> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int quest_expected_wins = values.get(position).questExpectedWins;
        int quest_current_wins = values.get(position).questCurrentWins;
