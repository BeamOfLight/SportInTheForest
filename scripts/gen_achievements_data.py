...
skill_points_values[7] = [10] * len(parameter_values[7])
skill_points_values[8] = [10] * len(parameter_values[8])
skill_points_values[9] = xrange(1, len(parameter_values[9]) + 1)
skill_points_values[10] = xrange(10, (len(parameter_values[10]) + 1) * 10, 10)
skill_points_values[11] = xrange(10, (len(parameter_values[11]) + 1) * 10, 10)

# exp_values
for i in xrange(9):
    exp_values[i] = [0] * len(parameter_values[i])

for j in xrange(len(parameter_values[9])):
    exp_values[9].append(10 * parameter_values[9][j])

for j in xrange(len(parameter_values[10])):
    exp_values[10].append(50 * parameter_values[10][j])

for j in xrange(len(parameter_values[11])):
    exp_values[11].append(100 * parameter_values[11][j])
